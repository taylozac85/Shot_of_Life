...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { average_rating: @drink.average_rating, description: @drink.description, drink_name: @drink.drink_name }
    end
  ...
  test "should update drink" do
    put :update, id: @drink, drink: { average_rating: @drink.average_rating, description: @drink.description, drink_name: @drink.drink_name }
    assert_redirected_to drink_path(assigns(:drink))
  end
